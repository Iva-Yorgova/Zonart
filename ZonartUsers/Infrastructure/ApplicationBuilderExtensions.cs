...
namespace ZonartUsers.Infrastructure
{
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        private static void SeedTemplates(ZonartUsersDbContext data)
        {
            ...
            {
            new Template { Price = 10.0, Name = "Sunshine", ImageUrl = "../Images/Templates/01.jpg", Description = "Flat summer instagram post collection with photos"},
            ...
            new Template { Price = 12.0, Name = "Lively" , ImageUrl = "../Images/Templates/07.jpg", Description = "Butterfly instagram post collection"}
             });
